...
int main()
{
    ...
    sf::RenderWindow window(sf::VideoMode(1600, 400), "GoodBye from Bob"); // X.H. changed the title of the window to "GoodBye from Bob" 
    ...
    // Choose a color
    sf::Color col(0, 0, 255); // X.H. changed the color of the txt from (255, 255, 255) to (0, 0, 255) which is dark blue
