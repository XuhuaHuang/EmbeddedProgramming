...
int main() {
    ...
    do {
        int choice = 0, choiceDishPC = 0, choiceBB = 0, choiceSuitcasePB = 0,
            tryAgain = 0;     // integer variable for choices
        ...
        do {
            ...
            if (choice == 1) // bowl
            {
                do {
                    ...
                    cout << "After his rest he wondered what to do next. Maybe having a drink or something to eat "
                            "would help.\n"
                         << "\n";
                    cout << "\033[1;31m"; // Change colour to red
        ...
        if (choiceBB == 1) // bag
        {
            do {
                ...
                if (choice == 1)   // suitcase
                    choiceSuitcasePB =
                        1;            // X.H. changed "choiceSuitcasePB = 2 to = 1 to match the later on if statements
                else if (choice == 2) // plastice bags
                    choiceSuitcasePB = 2;
                else {
                    cout << "Not a valid choice. Please try again.\n" << "\n";
