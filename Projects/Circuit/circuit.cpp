...
RESISTOR::RESISTOR(double initValue, double initPowerRating)
    : COMPONENT(initValue) {
...
void RESISTOR::printInfo(void) {
    ...
    std::cout << "[fn][RESISTOR]Private member \'powerRating\' = " << std::fixed << getPowerRating() << " W" << "\n";
}
...
****************************************/
INDUCTOR::INDUCTOR()
    : COMPONENT(0.00047) // default constructor pass 0.00047 henry
{
    std::cout << "\n[DECONST]INDUCTOR" << "\n"
