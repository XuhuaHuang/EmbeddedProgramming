...
// function prototype:
void print_int_vector(std::vector<int>);
void print_char_vector(std::vector<char>);
...
int main(void) {
  ...
  v1.resize(10, 0);
  print_int_vector(v1); // two zeros at the end as recently added element
  ...
  v1.clear();
  std::cout << "\nClearing..." << "\n";
  print_int_vector(v1);                                                    // empty std::vector -> nothing
  std::cout << "The size of std::vector v1 is now: " << v1.size() << "\n"; // should print 9

  /*
  std::cout << "Sorting..." << "\n";
  sort(v1.begin(), v1.end()); // sort function
  print_int_vector(v1); // print sorted acceding std::vector

  std::cout << "Reversing..." << "\n";
  reverse(v1.begin(), v1.end()); // reverse function
  print_int_vector(v1); // print reversed std::vector
  */
  ...
  */
  ...
  print_int_vector(vA); // print sorted

  std::cout << "\nReversing..." << "\n";
  std::reverse(vA.begin(), vA.end());
  print_int_vector(vA); // print reversed
  ...
  */
  ...
  print_char_vector(vB); // print sorted

  std::cout << "\nReversing..." << "\n";
  std::reverse(vB.begin(), vB.end());
  print_char_vector(vB); // print reversed

  std::cout << "\nShuffling..." << "\n";
  std::shuffle(vB.begin(), vB.end(), g);
  print_char_vector(vB); // print shuffled
  ...
  // for std::vector<std::string>, I think the reason why it does NOT work is I had to go into the first element and
  // reverse the element. instead of reversing the std::string std::vector
...
void print_int_vector(std::vector<int> intv) {
...
void print_char_vector(std::vector<char> charv) {
