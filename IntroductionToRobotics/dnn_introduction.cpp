/**
 * @file dnn_introduction.cpp
 * @author Xuhua Huang
 * @brief
 * @version 0.1
 * @date 2023-10-09 Happy Thanksgiving from Canada!
 *
...
try
{
    ...
    if (argc != 2)
    {
        ...
        std::cout << "You can get MNIST from http://yann.lecun.com/exdb/mnist/"
                  << "\n";
        std::cout << "Download the 4 files that comprise the dataset, decompress them, and"
                  << "\n";
        std::cout << "put them in a folder. Then give that folder as input to this program"
                  << "\n";
        return 1;
    }
    ...
    std::cout << "training accuracy:  " << num_right / static_cast<double>(num_right + num_wrong) << "\n";
    ...
    std::cout << "testing num_right: " << num_right << "\n";
    std::cout << "testing num_wrong: " << num_wrong << "\n";
    std::cout << "testing accuracy:  " << num_right / static_cast<double>(num_right + num_wrong) << "\n";
