...
int main(void)
{
	std::cout.precision(2); // force double digits with using "std::std::fixed" in this scope i.e. main function
	...
	std::cout << "\nAttempting to withdraw bigger amout of money than there is from \"myCheckingAccount2\"..." << "\n";
