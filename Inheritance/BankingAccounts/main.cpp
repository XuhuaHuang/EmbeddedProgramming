...
int main(void) {
    ...
    std::cout << "\nNew account created with overloaded constructor.\nAccount balance is at: " << std::fixed
              << my100Account.getBalance() << "\n"; // $100
    ...
    std::cout << "\nAfter depositting into my credit account, latest availble balance is: $ " << std::fixed
              << myAccount1.getBalance() << "\n";

    std::cout << "\nWithdrawing $250.25..." << "\n";
    myAccount1.debit(250.25); // 500.50 - 250.25 = 250.25 without fee
    std::cout << "\nAfter withdrawing from debit account, latest availble balance is: $ " << std::fixed
              << myAccount1.getBalance() << "\n";

    std::cout << "\nAttempting to withdraw $300.30..." << "\n";
    myAccount1.debit(300.30); // not enough funds to withdraw, print error only
    std::cout << "\nKnown no changes should have been made to myAccount1. Balance remains: $ " << std::fixed
              << myAccount1.getBalance() << "\n";
    ...
    std::cout << "\nObject \"mySavingsAccount1\" is created.\nCurrent balance is at: $ " << std::fixed
              << mySavingsAccount1.getBalance() << "\n";
    ...
    std::cout << "For \"mySavingsAccount2\", initial balance is set to: $ " << std::fixed
              << mySavingsAccount2.getBalance() << "\n";
    ...
    std::cout << "For \"myCheckingAccount2\", initial balance is set to: $ " << std::fixed
              << myCheckingAccount2.getBalance() << "\n";
    ...
    std::cout << "\nKnown no changes should have been made to \"myCheckingAccount2\". Balance remains: $ " << std::fixed
              << myCheckingAccount2.getBalance() << "\n";
