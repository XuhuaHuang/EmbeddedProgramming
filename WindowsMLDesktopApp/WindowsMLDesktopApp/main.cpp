...
winrt::hstring    imagePath =
    L"C:\\Users\\hux1mis\\source\\repos\\EmbeddedProgramming\\WindowsMLDesktopApp\\WindowsMLDesktopApp\\image\\kitten_"
    L"224.png";
...
void LoadLabels() {
    ...
    if (labelFile.fail()) {
        printf(
            "failed to load the %s file.  Make sure it exists in the same folder as the app\r\n", labelsFilePath.c_str()
        );
        exit(EXIT_FAILURE);
    }
