...
public:
    ...
    Circle(int newRadius) {
        setRadius(newRadius);
        setArea((double)newRadius * newRadius * PI);
    }
};
...
public:
    ...
    Colour(std::string customColour) {
        setLineColour(customColour);
        setFillColour(customColour);
    }
};
...
public:
    ...
    ColouredCircle()
        ...
        , Colour() {}
    // overload constructor
    ColouredCircle(int newRadius, std::string customColour)
        : Circle(newRadius)
        , Colour(customColour) {}
};
